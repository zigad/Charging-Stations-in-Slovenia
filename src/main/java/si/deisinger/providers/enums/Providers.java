...
public enum Providers {
    GREMONAELEKTRIKO(1, "GremoNaElektriko", "https://cp.emobility.gremonaelektriko.si/api/v2/app/pins?includeAvailability=false", "https://cp.emobility.gremonaelektriko.si/api/v2/app/locations"), PETROL(
            2, "Petrol",
            "https://onecharge.eu/DuskyWebApi/api/locations?searchLatitude=46.119944&searchLongitude=14.815333&searchRadius=500&showAlsoRoaming=false&onlyCurrentlyAvailable=false&onlyFreeOfCharge=false"
    ), MOONCHARGE(
            ...
            5, "MegaTel", "https://megatel.eu.charge.ampeco.tech/api/v2/app/pins",
            "https://megatel.eu.charge.ampeco.tech/api/v2/app/locations"
